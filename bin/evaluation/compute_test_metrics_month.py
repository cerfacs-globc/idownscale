...
from iriscc.settings import CONFIG, DATASET_BC_DIR, DATASET_DIR, GRAPHS_DIR, METRICS_DIR, RUNS_DIR
from iriscc.transforms import FillMissingValue, LandSeaMask, Log10Transform, MinMaxNormalisation, Pad, UnPad
...
def preprocess(year: int, month: int, sample_dir: Path, model: Optional[nn.Module], transforms: Optional[Compose]) -> Tuple[np.ndarray, np.ndarray]:
    """
