...
if __name__ == "__main__":
    ...
    ds_test_future.to_netcdf(
        RCM_RAW_DIR / f"ALADIN_reformat/tas_EUR-12_CNRM-ESM2-1_{period}_r1i1p1f2_CNRM-MF_CNRM-ALADIN64E1_v1-r1_day_{startdate}-{enddate}_reformat_{target}.nc"
    )
