...
CONFIG = {
    "exp3": {
        "target": "safran",
        "domain": [-6.0, 12.0, 40.0, 52.0],
        "domain_xy": [60000, 1196000, 1617000, 2681000],
        "data_projection": ccrs.LambertConformal(
            central_longitude=2.337229, central_latitude=46.8, false_easting=600000, false_northing=2200000, standard_parallels=(45.89892, 47.69601)
        ),
        "fig_projection": ccrs.LambertConformal(central_latitude=46.0, central_longitude=2.0),
    ...
    {
        "target": "eobs",
        "domain": {"france": [-6.0, 10.0, 38, 54], "europe": [-12.5, 27.5, 31.0, 71.0], "tchequie": [11.5, 19.5, 45.75, 53.75]},
        "data_projection": ccrs.PlateCarree(),
        "fig_projection": {
            "france": ccrs.LambertConformal(central_latitude=46.0, central_longitude=2.0),
            "europe": ccrs.LambertConformal(central_latitude=51.0, central_longitude=7.5),
            "tchequie": ccrs.LambertConformal(central_latitude=45.75, central_longitude=11.5),
        },
        "shape": {"france": (64, 64), "europe": (160, 160), "tchequie": (32, 32)},
    ...
    "exp8": {
        ...
        "target_vars": ["pr"],
        "input_vars": ["elevation", "zg500", "zg700", "zg850", "ta500", "ta700", "ta850", "ua500", "ua700", "ua850", "vas", "uas", "psl"],
        "channels": [
            "elevation",
            "zg500 input",
            "zg700 input",
            ...
            "psl input",
            "pr target",
        ],  # to not get lost for normalization
        "ssp": "ssp585",
    },
}
