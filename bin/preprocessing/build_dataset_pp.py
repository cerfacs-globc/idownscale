...
from iriscc.settings import CONFIG, DATASET_BC_DIR, DATES_BC_TEST_FUTURE, DATES_BC_TEST_HIST, DATES_BC_TRAIN_HIST, GCM_RAW_DIR
...
if __name__ == "__main__":
    ...
    for date in DATES_BC_TRAIN_HIST:
        ...
        x = np.stack(x, axis=0)
        y = get_data.get_target_dataset(target=CONFIG[exp]["target"], var=var, date=date)
        sample = {"x": x, "y": y}
