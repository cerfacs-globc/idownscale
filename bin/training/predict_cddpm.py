...
if __name__ == "__main__":
    ...
    intermediate_images = generate(model.model, conditioning_image, n_samples=2, neighbours=False, std=1e-1, start_t=None, clamp=None, device="cpu")
    ...
    compare_4_subplots(conditioning_image_init, y[0], y_hat, False, f"{args.date} {test_name}", GRAPHS_DIR / f"pred/{args.date}_subplot_{args.exp}_{test_name}.png")
# jscpd:ignore-end
